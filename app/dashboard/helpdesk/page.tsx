    ...
    <div className="min-h-screen" style={{ background: '#f4f6f9' }}>
      <header style={{ background: '#1e3a5f' }} className="shadow-lg">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 flex gap-0.5">
          ...
          <Link href="/dashboard/category"            className="px-4 py-2 text-xs font-medium rounded-t-md text-blue-200 hover:text-white hover:bg-white/10 transition-all">Category Analysis</Link>
